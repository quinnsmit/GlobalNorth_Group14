document.addEventListener('DOMContentLoaded', () => {
    ...
    // Replace the accessibleBtn event listener with this toggle logic
    const accessibleBtn = document.getElementById('accessibleMode');
    if (accessibleBtn) {
        accessibleBtn.addEventListener('click', async () => {
            accessibleModeOn = !accessibleModeOn; // toggle state
            ...
            // Update button text to reflect state (optional)
...
// Function still required for guide generation
